...
const TechStackTile = ({ item }: { item: TechStackItem }) => (
    <div className="flex flex-col items-center gap-2 text-center rounded-2xl border border-white/10 bg-white/2 px-3 py-4 transition-all hover:border-primary-400/40 ">
...
const TechStackCategoryCard = ({ category }: { category: TechStackCategory }) => {
    ...
    return (
        <article className="relative overflow-hidden rounded-3xl border border-white/6 bg-[#101017]/60 shadow-[0_35px_120px_rgba(0,0,0,0.35)] transition-transform duration-500 hover:border-primary-400/40 hover:-translate-y-2 hover:shadow-[0_35px_130px_rgba(0,0,0,0.55)]">
        ...
        <section id="section-stack" className="scroll-mt-20 py-12 lg:py-14 px-6 sm:px-10 relative">
            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                <div className="text-center mb-12">
                    <h2 className="text-3xl sm:text-4xl font-bold text-white mt-3">Tech Stack</h2>
                    <p className="text-xs tracking-[0.35em] text-primary uppercase">Capabilities</p>
