        ...
        <section id="section-contact" className="scroll-mt-20 py-10 sm:py-12 px-6 sm:px-10 relative">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
                <div className="text-center mb-14">
                    <h2 className="mt-3 text-3xl font-bold text-(--theme-text) sm:text-4xl">{sectionText.title}</h2>
                ...
                <div className="theme-panel-solid theme-panel-hover overflow-hidden rounded-2xl">
                    ...
                    <div className="p-4 sm:p-6 lg:p-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                            {contacts.map((item) => (
                                <div key={item.value} className="theme-soft flex items-center gap-3 rounded-xl border border-(--theme-border) p-3 transition-transform duration-500 hover:-translate-y-1 hover:border-primary/20 sm:gap-4 sm:p-4">
